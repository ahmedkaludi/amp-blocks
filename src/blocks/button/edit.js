	...
	componentDidMount() {
		if (!this.props.attributes.uniqueID) {
			...
			const blockConfigObject = amp_blocks_params.configuration
				...
				: [];
			if (
				blockConfigObject["amp/advancedbtn"] !== undefined &&
				typeof blockConfigObject["amp/advancedbtn"] === "object"
			) {
				Object.keys(blockConfigObject["amp/advancedbtn"]).map((attribute) => {
					this.props.attributes[attribute] =
						blockConfigObject["amp/advancedbtn"][attribute];
				});
			} else if (
				oldBlockConfig !== undefined &&
				typeof oldBlockConfig === "object"
			) {
			...
			advancedbuttonUniqueIDs.includes(this.props.attributes.uniqueID)
		) {
			this.props.setAttributes({
				uniqueID: "_" + this.props.clientId.substr(2, 3),
			});
		...
		const blockSettings = amp_blocks_params.settings
			...
			: {};
		if (
			blockSettings["amp/advancedbtn"] !== undefined &&
			typeof blockSettings["amp/advancedbtn"] === "object"
		) {
	...
	render() {
		...
		const renderBtns = (index) => {
			...
			if (
				...
				btnGrad =
					"transparent" === btns[index].background ||
					undefined === btns[index].background
						? "rgba(255,255,255,0)"
						: hexToRGBA(
								btns[index].background,
								btns[index].backgroundOpacity !== undefined
									? btns[index].backgroundOpacity
									: 1
						  );
				btnGrad2 =
					...
					"" !== btns[index].gradient[0]
						? hexToRGBA(
								btns[index].gradient[0],
								undefined !== btns[index].gradient &&
									btns[index].gradient[1] !== undefined
				...
				if (
					undefined !== btns[index].gradient &&
					"radial" === btns[index].gradient[4]
				) {
					btnbg = `radial-gradient(at ${
						undefined === btns[index].gradient[6]
							? "center center"
							: btns[index].gradient[6]
					}, ${btnGrad} ${
						undefined === btns[index].gradient[2]
							? "0"
							: btns[index].gradient[2]
					}%, ${btnGrad2} ${
						undefined === btns[index].gradient[3]
							? "100"
					...
					btnbg = `linear-gradient(${
						undefined !== btns[index].gradient &&
						undefined !== btns[index].gradient[5]
			...
			return (
				<div
					className={`btn-area-wrap b-${index}-area`}
					style={{
						marginRight: btns[index].gap + "px",
					}}
				>
					<span
						className={`b-wrap b-${index}-action b-svg-show-${
							!btns[index].iconHover ? "always" : "hover"
						}`}
					>
						<span
							className={`b b-${index} b-size-${
								btns[index].btnSize ? btns[index].btnSize : btnSize
							} b-style-${
								btns[index].btnStyle ? btns[index].btnStyle : "basic"
							}`}
							style={{
								background: undefined !== btnbg ? btnbg : undefined,
								color:
									undefined !== btns[index].color
										? btns[index].color
										: undefined,
								fontSize:
									undefined !== btns[index].size
										? btns[index].size + "px"
										: undefined,
								...
								borderRadius:
									undefined !== btns[index].borderRadius
										? btns[index].borderRadius + "px"
										: undefined,
								borderWidth:
									undefined !== btns[index].borderWidth
								...
								borderColor:
									undefined === btns[index].border
										...
										: hexToRGBA(
												btns[index].border,
												btns[index].borderOpacity !== undefined
													? btns[index].borderOpacity
													: 1
										  ),
								...
								boxShadow:
									...
									btns[index].boxShadow[0]
										? (undefined !== btns[index].boxShadow[7] &&
										  btns[index].boxShadow[7]
												? "inset "
												: "") +
										  (undefined !== btns[index].boxShadow[3]
												? btns[index].boxShadow[3]
												: 1) +
										  "px " +
										  (undefined !== btns[index].boxShadow[4]
												? btns[index].boxShadow[4]
												: 1) +
										  "px " +
										  (undefined !== btns[index].boxShadow[5]
												? btns[index].boxShadow[5]
												: 2) +
										  "px " +
										  (undefined !== btns[index].boxShadow[6]
										  ...
										  hexToRGBA(
												undefined !== btns[index].boxShadow[1]
													...
													: "#000000",
												undefined !== btns[index].boxShadow[2]
						...
						>
							{btns[index].icon && "left" === btns[index].iconSide && (
								<GenIcon
									className={`b-svg-icon b-svg-icon-${btns[index].icon} b-side-${btns[index].iconSide}`}
									name={btns[index].icon}
									size={!btns[index].size ? "14" : btns[index].size}
									icon={
										"fa" === btns[index].icon.substring(0, 2)
											? FaIco[btns[index].icon]
											: Ico[btns[index].icon]
									}
								/>
							)}
					...
					{isSelected &&
						((this.state.btnFocused &&
							"btn" + [index] === this.state.btnFocused) ||
							(this.state.btnFocused &&
								"false" === this.state.btnFocused &&
								"0" === index)) && (
							<BlockControls>
								<Toolbar>
									<URLInputButton
			...
			return (
				<div>
					<AdvancedColorControl
						...
						colorValue={
							btns[index].colorHover ? btns[index].colorHover : "#ffffff"
						}
						colorDefault={"#ffffff"}
						onColorChange={(value) => {
					...
					<div className="b-size-settings-container">
						<h2 className="amp-beside-btn-group">
							{__("Background Type", "amp-blocks")}
						</h2>
						<ButtonGroup
							className="b-size-type-options"
							aria-label={__("Background Type", "amp-blocks")}
						>
							{map(bgType, ({ name, key }) => (
								<Button
									key={key}
									...
									onClick={() =>
										this.saveArrayUpdate({ backgroundHoverType: key }, index)
									}
								>
									{name}
								</Button>
					...
					{"gradient" === btns[index].backgroundHoverType && (
						<div className="amp-inner-sub-section">
									...
									this.saveArrayUpdate(
										{
											gradientHover: [
												...
												undefined !== btns[index].gradientHover[3]
													...
													: 100,
												btns[index].gradientHover &&
												undefined !== btns[index].gradientHover[4]
							...
							<div className="b-size-settings-container">
								<h2 className="amp-beside-btn-group">
									{__("Gradient Type", "amp-blocks")}
								</h2>
								<ButtonGroup
									className="b-size-type-options"
									aria-label={__("Gradient Type", "amp-blocks")}
								>
					...
					<AdvancedColorControl
						...
						colorValue={
							btns[index].borderHover ? btns[index].borderHover : "#444444"
						}
						colorDefault={"#444444"}
					...
					<BoxShadowControl
						...
						color={
							undefined !== btns[index].boxShadowHover &&
							undefined !== btns[index].boxShadowHover[1]
						...
						opacity={
							undefined !== btns[index].boxShadowHover &&
							undefined !== btns[index].boxShadowHover[2]
								? btns[index].boxShadowHover[2]
								: 0.4
						}
						hOffset={
							undefined !== btns[index].boxShadowHover &&
							undefined !== btns[index].boxShadowHover[3]
								? btns[index].boxShadowHover[3]
								: 2
						}
						vOffset={
							undefined !== btns[index].boxShadowHover &&
							undefined !== btns[index].boxShadowHover[4]
								? btns[index].boxShadowHover[4]
								: 2
						}
						blur={
							undefined !== btns[index].boxShadowHover &&
							undefined !== btns[index].boxShadowHover[5]
								? btns[index].boxShadowHover[5]
								: 3
						}
						spread={
							undefined !== btns[index].boxShadowHover &&
							undefined !== btns[index].boxShadowHover[6]
								? btns[index].boxShadowHover[6]
								: 0
						}
						inset={
							undefined !== btns[index].boxShadowHover &&
							undefined !== btns[index].boxShadowHover[7]
						...
						>
							{map(bgType, ({ name, key }) => (
								<Button
									...
									onClick={() =>
										this.saveArrayUpdate({ backgroundType: key }, index)
									}
								>
									{name}
								</Button>
									...
									this.saveArrayUpdate(
										{
											gradient: [
												...
												undefined !== btns[index].gradient[0]
													...
													: "#999999",
												btns[index].gradient &&
												undefined !== btns[index].gradient[1]
													? btns[index].gradient[1]
													: 1,
												value,
												btns[index].gradient &&
												undefined !== btns[index].gradient[3]
													...
													: 100,
												btns[index].gradient &&
												undefined !== btns[index].gradient[4]
		...
		const renderPreviewArray = (
			<div>{times(btnCount, (n) => renderBtns(n))}</div>
		);
		const renderBtnCSS = (index) => {
			...
			if (
				...
				btnGrad =
					undefined === btns[index].backgroundHover
						? hexToRGBA(
								"#444444",
								btns[index].backgroundHoverOpacity !== undefined
									? btns[index].backgroundHoverOpacity
									: 1
						  )
						: hexToRGBA(
								btns[index].backgroundHover,
				...
				btnGrad2 =
					undefined === btns[index].gradientHover[0]
						? hexToRGBA(
								"#777777",
								btns[index].gradientHover[1] !== undefined
									? btns[index].gradientHover[1]
									: 1
						  )
						: hexToRGBA(
				...
				if (
					undefined !== btns[index].gradientHover &&
					"radial" === btns[index].gradientHover[4]
				) {
					btnbg = `radial-gradient(at ${
						undefined === btns[index].gradientHover[6]
							? "center center"
			...
			if (
				...
				btnRad =
					undefined !== btns[index].borderRadius
						? btns[index].borderRadius
						: "3";
				btnBox = "none";
			}
			return `#b_${uniqueID} .b-${index}:hover {
					color: ${btns[index].colorHover} !important;
					border-color: ${hexToRGBA(
						undefined === btns[index].borderHover
							? "#444444"
							: btns[index].borderHover,
						btns[index].borderHoverOpacity !== undefined
							? btns[index].borderHoverOpacity
							: 1
					)} !important;
		...
		return (
			<Fragment>
				...
				<div
					id={`b_${uniqueID}`}
					className={`bp ${className} b-align-${hAlign}${
						forceFullwidth ? " amp-force-btn-fullwidth" : ""
					}`}
				>
					<BlockControls>
						<AlignmentToolbar
						...
						<Fragment>
								...
								<Fragment>
									<PanelBody
										title={
											...
											" " +
											__("Settings", "amp-blocks")
										}
										initialOpen={open}
									>
										<h2 className="side-h2-label">
											{__("Alignment", "amp-blocks")}
										</h2>
										<TabPanel
											...
											<Fragment>
												...
												<SelectControl
													...
													options={[
														{
															value: "_self",
															label: __("Same Window", "amp-blocks"),
														},
														{
															value: "_blank",
															label: __("New Window", "amp-blocks"),
														},
														{
															value: "video",
															label: __("Video Popup", "amp-blocks"),
														},
													]}
													onChange={(value) => {
														this.saveArrayUpdate(
												...
												<ToggleControl
													...
													checked={
														undefined !== btns[indexcountamp].noFollow
															? btns[indexcountamp].noFollow
															: false
													}
													onChange={(value) =>
														this.saveArrayUpdate(
										...
										{true && (
											<Fragment>
												{true && (
													<div className="amp-inner-sub-section">
														<h2 className="amp-heading-size-title amp-secondary-color-size">
															{__("Padding", "amp-blocks")}
														</h2>
														<TabPanel
															className="amp-size-tabs"
															activeClass="active-tab"
										...
										{this.showSettings("colorSettings") && (
											<Fragment>
												<h2 className="amp-tab-wrap-title amp-color-settings-title">
													{__("Color Settings", "amp-blocks")}
												</h2>
												<TabPanel
													className="amp-inspect-tabs amp-hover-tabs"
													activeClass="active-tab"
													tabs={[
														{
										...
										<TextControl
											...
											value={
												btns[indexcountamp].cssClass
													? btns[indexcountamp].cssClass
													: ""
											}
											onChange={(value) =>
												this.saveArrayUpdate({ cssClass: value }, indexcountamp)
											}
										/>
									</PanelBody>
										...
										>
											<TypographyControls
												...
												onLoadGoogleFont={(value) =>
													setAttributes({ loadGoogleFont: value })
												}
												...
												onFontSubset={(value) =>
													setAttributes({ fontSubset: value })
												}
											/>

											<h2 className="amp-heading-size-title">
												{__("Button Size", "amp-blocks")}
											</h2>
											<TabPanel
												className="amp-size-tabs"
												activeClass="active-tab"
														...
														if ("mobile" === tab.name) {
															tabout = (
																<RangeControl
																	...
																	value={
																		undefined !==
																			btns[indexcountamp].responsiveSize &&
																		undefined !==
																			btns[indexcountamp].responsiveSize[1]
																			? btns[indexcountamp].responsiveSize[1]
																			: ""
																	}
																	onChange={(value) => {
																...
																<RangeControl
																	...
																	value={
																		undefined !==
																			btns[indexcountamp].responsiveSize &&
																		undefined !==
																			btns[indexcountamp].responsiveSize[0]
																			? btns[indexcountamp].responsiveSize[0]
																			: ""
																	}
																	onChange={(value) => {
							...
							<InspectorAdvancedControls>
								<ToggleControl
									...
									checked={
										undefined !== forceFullwidth ? forceFullwidth : false
									}
					...
					<div
						...
						className={"btn-inner-wrap aos-animate amp-animation-wrap"}
