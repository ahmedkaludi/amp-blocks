...
class Amp_Blocks_Frontend
{
	...
	public function row_layout_array_css($attr, $unique_id)
	{
		...
		if (isset($attr['textColor'])) {
			$css .= '.amp-layout-id' . $unique_id . ', .amp-layout-id' . $unique_id . ' h1, .amp-layout-id' . $unique_id . ' h2, .amp-layout-id' . $unique_id . ' h3, .amp-layout-id' . $unique_id . ' h4, .amp-layout-id' . $unique_id . ' h5, .amp-layout-id' . $unique_id . ' h6 {';
			$css .= 'color:' . $attr['textColor'] . ';';
			$css .= '}';
		}
		if (isset($attr['linkColor'])) {
			$css .= '.amp-layout-id' . $unique_id . ' a {';
			$css .= 'color:' . $attr['linkColor'] . ';';
			$css .= '}';
		}
		if (isset($attr['linkHoverColor'])) {
			$css .= '.amp-layout-id' . $unique_id . ' a:hover {';
			...
			foreach ($attr['btns'] as $btnkey => $btnvalue) {
				if (is_array($btnvalue)) {
					if (isset($btnvalue['gap']) && is_numeric($btnvalue['gap'])) {
						$css .= '.amp-btns' . $unique_id . ' .amp-btn-wrap-' . $btnkey . ' {';
					...
					$css .= '.amp-btns' . $unique_id . ' .amp-btn-wrap-' . $btnkey . ' .amp-button {';
					...
					$css .= '}';
					$css .= '.amp-btns' . $unique_id . ' .amp-btn-wrap-' . $btnkey . ' .amp-button:hover, .amp-btns' . $unique_id . ' .amp-btn-wrap-' . $btnkey . ' .amp-button:focus {';
					...
					$css .= '}';
					if ('gradient' === $bgtype) {
						$css .= '.amp-btns' . $unique_id . ' .amp-btn-wrap-' . $btnkey . ' .amp-button::before {';
